...
<div class="container mt-5">
    <div class="row">
        ...
        <div class="col-md-6 mb-4">
            <img src="https://picsum.photos/500/500" alt="Product" class="img-fluid rounded mb-3 product-image" id="mainImage">
            <div class="d-flex justify-content-between">
                <img src="https://picsum.photos/500/500" alt="Thumbnail 1" class="thumbnail rounded active" onclick="changeImage(event, this.src)">
                <img src="https://picsum.photos/500/500" alt="Thumbnail 2" class="thumbnail rounded" onclick="changeImage(event, this.src)">
                <img src="https://picsum.photos/500/500" alt="Thumbnail 3" class="thumbnail rounded" onclick="changeImage(event, this.src)">
                <img src="https://picsum.photos/500/500" alt="Thumbnail 4" class="thumbnail rounded" onclick="changeImage(event, this.src)">
            </div>
        </div>

        <!-- Product Details -->
        <div class="col-md-6">
            <h2 class="mb-3">{{$productdetail->name}}</h2>
